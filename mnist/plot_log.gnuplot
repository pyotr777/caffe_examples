...
reset
set terminal png
set output "your_chart_name2.png"
...
#plot "caffe.tegra-ubuntu-1.nvidia.log.INFO.20170704-032208.4318.train" using 1:3 title "mnist"
...
plot "caffe.tegra-ubuntu-1.nvidia.log.INFO.20170704-032208.4318.test" using 1:4 title "mnist test loss"
